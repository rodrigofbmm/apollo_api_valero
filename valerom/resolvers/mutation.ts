...
export const Mutation = {
  ...
  deletePet: async (
    ...
    const pet = (await PetModel.findByIdAndDelete(args.id)) as unknown as PetModelType;
    if (!pet) {
  ...
  deletePerson: async (
    ...
    const person = (await PersonModel.findByIdAndDelete(args.id)) as unknown as PersonModelType;
    if (!person) {
